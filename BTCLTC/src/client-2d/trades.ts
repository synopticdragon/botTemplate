...
@Component({
  selector: 'trade-list',
  template: `<ag-grid-angular #tradeList class="ag-fresh ag-dark" style="display:none !important; height: 182px;width: 99.80%;" rowHeight="21" [gridOptions]="gridOptions" (cellClicked)="onCellClicked($event)"></ag-grid-angular>`
})
