        ...
        <div class="container-fluid">
            <div style="perspective: 100vw;">
                <div id="hud_nav" [ngClass]="pair.connected ? 'bg-success' : 'bg-danger'">
                  <a style="display:none;" [hidden]="!exchange_market" href="{{ exchange_market }}" target="_blank">Market</a>
                  <br/><a style="display:none;" [hidden]="!exchange_orders" href="{{ exchange_orders }}" target="_blank">Orders</a>
                  <br/><br/><div>
                      <button type="button"
			      style="display:none;"
				...
				style="display:none;"
                              ...
                              data-placement="bottom">Clean Orders
                      </button>
                  </div>
				...
				style="display:none;"
                  ...
                  <br [hidden]="exchange_name=='HitBtc'" /><a style="display:none;" [hidden]="exchange_name=='HitBtc'" href="#" (click)="toggleWatch(exchange_name.toLowerCase(), this.pair_name.join('-').toLowerCase())">Watch</a><br [hidden]="exchange_name=='HitBtc'" />
                  <br/><a style="display:none;" href="#" (click)="toggleTakers()">Takers</a>
                ...
                <div id="hud" [ngClass]="pair.connected ? 'bg-success img-rounded' : 'bg-danger img-rounded'">
                    <div *ngIf="online" class="row" [hidden]="!showSettings">
						...
						<select class="form-control input-sm"						 
                                                   [(ngModel)]="pair.quotingParameters.display.pongAt" id="removepong">
						    <ng-container *ngFor="let option of pair.quotingParameters.availablePongAt">
                                                   <option *ngIf="option.val==0 || option.val==2" [ngValue]="option.val" >{{option.str}}</option>
						</ng-container>
                                                </select>
					    </td>
                                            <td style="min-width:121px;border-bottom: 3px solid #DDE28B;">
