  ...
  class OG: public Klass {
    ...
    protected:
      void load() {
       ...
       // ((SH*)screen)->log("DB", string("loaded hi boyan ") + to_string(tradesHistory.size()) + " historical Trades");
	((SH*)screen)->log("DB", string("loaded Trade History "));
      };
      void waitData() {
    ...
    //   ((SH*)screen)->log("DB", "\n\n=============\nPRICe" + FN::str8(o->price) + "\n Quantiy " + FN::str8(o->quantity) + 
      //                              "\nReplace THis Order\n\n");
	...
	sonaliSync(o->orderId, (side == mSide::Bid ? "1" : "2"), trTransactTime(), FN::str8(o->price), FN::str8(o->quantity), (string(o->pair.base) + string(o->pair.quote))); //_SP
	
	if( replaceOrderId.length() > 10)	
	{
		cancelsendFixPeatio(replaceOrderId, (o->side == mSide::Bid ? "1" : "2"), trTransactTime(),FN::str8(o->price), FN::str8(o->quantity), (string(o->pair.base) + string(o->pair.quote)));
...
//        debug(string("cancel ") + (o->side == mSide::Bid ? "\n\nBID id " : "\n\nASK id ") +" \n=======WAIT!!!!WHAT IS THIS======\n "+ o->orderId + "::" + o->exchangeId);
  //      ((SH*)screen)->log("DB", "\n\nCANCEL ALL ORDERS LIKE THIS\n\n");

        cancelsendFixPeatio(o->orderId, (o->side == mSide::Bid ? "1" : "2"), trTransactTime(),FN::str8(o->price), FN::str8(o->quantity), (string(o->pair.base) + string(o->pair.quote)));
    ...
    private:
      ...
      inline void toHistory(mOrder *o, double tradeQuantity) {
        ...
        ((SH*)screen)->log(trade, gw->name, o->orderId);
        if (qp->_matchPings) {
