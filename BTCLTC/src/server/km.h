...
namespace K {
  enum class mExchange: unsigned int { BeaXchange, HitBtc, OkCoin, Coinbase, Bitfinex, Kraken, OkEx, BitfinexMargin, Korbit, Poloniex };
  ...
  struct mQuotingParams {
    mPrice            widthPing                       = 0.008;
    double            widthPingPercentage             = 0.05;
    mPrice            widthPong                       = 0.008;
    double            widthPongPercentage             = 0.05;
    bool              widthPercentage                 = false;
    bool              bestWidth                       = true;
    mAmount           buySize                         = 0.008;
    unsigned int      buySizePercentage               = 2;
    bool              buySizeMax                      = false;
    mAmount           sellSize                        = 0.008;
    unsigned int      sellSizePercentage              = 2;
    ...
    mPrice            range                           = 0.5;
    double            rangePercentage                 = 2.0;
    mFairValueModel   fvModel                         = mFairValueModel::BBO;
    mAmount           targetBasePosition              = 1.0;
    unsigned int      targetBasePositionPercentage    = 10;
    mAmount           positionDivergence              = 0.9;
    mAmount           positionDivergenceMin           = 0.4;
    unsigned int      positionDivergencePercentage    = 2;
    unsigned int      positionDivergencePercentageMin = 2;
